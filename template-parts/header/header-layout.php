...
$header_layout_topbar_text = esc_html( get_theme_mod( 'carpenter_shop_header_layout_topbar_text',
$carpenter_shop_defaults['carpenter_shop_header_layout_topbar_text'] ) );

$header_layout_wishlist_link = esc_html( get_theme_mod( 'carpenter_shop_header_layout_wishlist_link',
$carpenter_shop_defaults['carpenter_shop_header_layout_wishlist_link'] ) );

$header_layout_wishlist_text = esc_html( get_theme_mod( 'carpenter_shop_header_layout_wishlist_text',
$carpenter_shop_defaults['carpenter_shop_header_layout_wishlist_text'] ) );

$header_layout_compare_link = esc_html( get_theme_mod( 'carpenter_shop_header_layout_compare_link',
$carpenter_shop_defaults['carpenter_shop_header_layout_compare_link'] ) );

$header_layout_compare_text = esc_html( get_theme_mod( 'carpenter_shop_header_layout_compare_text',
$carpenter_shop_defaults['carpenter_shop_header_layout_compare_text'] ) );

$header_layout_phone_number = esc_html( get_theme_mod( 'carpenter_shop_header_layout_phone_number',
...
<header id="site-header" class="site-header-layout header-layout" role="banner">
        ...
        <div class="wrapper header-wrapper">
            ...
            <div class="theme-header-areas header-areas-right">
                <?php if( $header_layout_phone_number ){ ?>
                    <span class="phone-area"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z"/></svg><a href="tel:<?php echo esc_attr( $header_layout_phone_number ); ?>"><?php echo esc_html( $header_layout_phone_number ); ?></a></span>
                <?php } ?>
                <?php if(class_exists('woocommerce')){ ?>
    ...
    <div class="header-navbar lower-header">
        <div class="wrapper header-wrapper">
            <div class="theme-header-areas header-areas-left">
                <?php if(class_exists('woocommerce')){ ?>
