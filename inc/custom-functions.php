...
if( !function_exists('carpenter_shop_single_post_navigation') ):
    ...
    function carpenter_shop_single_post_navigation(){
        ...
        if( $twp_navigation_type == '' || $twp_navigation_type == 'global-layout' ){
            $twp_navigation_type = get_theme_mod('twp_navigation_type', $carpenter_shop_default['twp_navigation_type']);
        }
...
if( !function_exists('carpenter_shop_footer_content_widget') ):
    ...
    function carpenter_shop_footer_content_widget(){
        ...
        $carpenter_shop_default = carpenter_shop_get_default_theme_options();
            $footer_column_layout = absint(get_theme_mod('footer_column_layout', $carpenter_shop_default['footer_column_layout']));
                    ...
                    <div class="column column-9">
                        <div class="footer-credits">
                            ...
                            <div class="footer-copyright">
                                ...
                                <?php
                                $footer_copyright_text = wp_kses_post( get_theme_mod( 'footer_copyright_text', $carpenter_shop_default['footer_copyright_text'] ) );
...
if( !function_exists( 'carpenter_shop_main_slider' ) ) :
    ...
    function carpenter_shop_main_slider(){
        ...
        $homepage_section_shipping_title = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_shipping_title',
        $carpenter_shop_defaults['carpenter_shop_homepage_section_shipping_title'] ) );

        $homepage_section_shipping_text = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_shipping_text',
        $carpenter_shop_defaults['carpenter_shop_homepage_section_shipping_text'] ) );

        $homepage_section_exchange_title = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_exchange_title',
        $carpenter_shop_defaults['carpenter_shop_homepage_section_exchange_title'] ) );

        $homepage_section_exchange_text = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_exchange_text',
        $carpenter_shop_defaults['carpenter_shop_homepage_section_exchange_text'] ) );

        $homepage_section_support_title = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_support_title',
        $carpenter_shop_defaults['carpenter_shop_homepage_section_support_title'] ) );

        $homepage_section_support_text = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_support_text',
        $carpenter_shop_defaults['carpenter_shop_homepage_section_support_text'] ) );

        $homepage_section_shopping_title = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_shopping_title',
        $carpenter_shop_defaults['carpenter_shop_homepage_section_shopping_title'] ) );

        $homepage_section_shopping_text = esc_html( get_theme_mod( 'carpenter_shop_homepage_section_shopping_text',
                        ...
                        <div class="header-wrapper">
                            <div class="theme-header-areas header-areas-left">
                                ...
                                <div class="header-areas-box">
                                    <?php if( $homepage_section_shipping_title ){ ?>
                                        <h6><?php echo esc_html( $homepage_section_shipping_title ); ?></h6>
                                    <?php } ?>
                                    <?php if( $homepage_section_shipping_text ){ ?>
                                        <p><?php echo esc_html( $homepage_section_shipping_text ); ?></p>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="theme-header-areas header-areas-left">
                                ...
                                <div class="header-areas-box">
                                    <?php if( $homepage_section_exchange_title ){ ?>
                                        <h6><?php echo esc_html( $homepage_section_exchange_title ); ?></h6>
                                    <?php } ?>
                                    <?php if( $homepage_section_exchange_text ){ ?>
                                        <p><?php echo esc_html( $homepage_section_exchange_text ); ?></p>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="theme-header-areas header-areas-right">
                                ...
                                <div class="header-areas-box">
                                    <?php if( $homepage_section_support_title ){ ?>
                                        <h6><?php echo esc_html( $homepage_section_support_title ); ?></h6>
                                    <?php } ?>
                                    <?php if( $homepage_section_support_text ){ ?>
                                        <p><?php echo esc_html( $homepage_section_support_text ); ?></p>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="theme-header-areas header-areas-right">
                                ...
                                <div class="header-areas-box">
                                    <?php if( $homepage_section_shopping_title ){ ?>
                                        <h6><?php echo esc_html( $homepage_section_shopping_title ); ?></h6>
                                    <?php } ?>
                                    <?php if( $homepage_section_shopping_text ){ ?>
                                        <p><?php echo esc_html( $homepage_section_shopping_text ); ?></p>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
