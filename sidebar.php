...
if (empty($carpenter_shop_post_sidebar)) {
    $global_sidebar_layout = esc_html( get_theme_mod( 'global_sidebar_layout',$carpenter_shop_default['global_sidebar_layout'] ) );
} else {
    $global_sidebar_layout = $carpenter_shop_post_sidebar;
}
